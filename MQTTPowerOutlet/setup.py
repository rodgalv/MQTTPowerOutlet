...
plugin_identifier = "MQTTPowerOutlet"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_MQTTPowerOutlet"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "MQTTPowerOutlet"
...
# module
plugin_description = """MQTT Plugin for Power Switch Outlet. Up to four outlets."""

# The plugin's author. Can be overwritten within OctoPrint's internal data via __plugin_author__ in the plugin module
plugin_author = "Rodrigo Galvao Barros Silva"

# The plugin's author's mail address.
plugin_author_email = "you@example.com"

# The plugin's homepage URL. Can be overwritten within OctoPrint's internal data via __plugin_url__ in the plugin module
plugin_url = "https://github.com/rodgalv/MQTTPowerOutlet"
